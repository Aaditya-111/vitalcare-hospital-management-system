                ...
                <div className="min-h-screen bg-gradient-to-br from-teal-50 via-blue-50 to-cyan-50 p-8">
                    <div className="max-w-2xl mx-auto">
                        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                            ...
                            <form action="/api/doctor/profile" method="POST" className="space-y-6">
                                <div>
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-gradient-to-r from-teal-500 to-blue-600 text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-95 transition-all duration-200"
                                >
                            ...
                            {doctor.schedules.length === 0 ? (
                                ...
                                <div className="space-y-3">
                                    {['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'].map((day, index) => {
                                        const daySchedules = doctor.schedules.filter(sch => sch.dayOfWeek === index)
                                        return (
